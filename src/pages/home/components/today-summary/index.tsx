...
export function TodaySummary({ copy, progress, summary }: TodaySummaryProps) {
  const percentage =
    summary.dailyGoal > 0
    ...
    <div className="hidden items-center gap-10 sm:flex">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-fluent-muted">{copy.navigation.dayStreak}</p>
        </div>
      </div>

      <div className="flex items-center gap-3">
        <div
          aria-label={copy.home.progressLabel(summary.completedToday, summary.dailyGoal)}
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-fluent-muted">{copy.home.today}</p>
        </div>
      </div>
    </div>
  );
